...
init python:
    ...
    splash_messages = [
        "Soap dispensers? More like... uh... stupid.",
        "Make sure to wash your hands you goobers.",
        "Deploy a soap dispenser here!",
        "This dispenser is an unofficial soap game that is unaffiliated with Team Soap Dispenser.",
        "WW91IHRvb2sgdGhlIHRpbWUgdG8gZGVjb2RlIHRoaXMgYmFzZTY0IHN0cmluZz8gRm9yIHdoYXQ/IFdlcmUgeW91IGV4cGVjdGluZyBhIHNlY3JldCBvciBlYXN0ZXIgZWdnPyBXZWxsIHRvbyBiYWQsIHlvdSd2ZSB3YXN0ZWQgYm90aCB5b3VyIHRpbWUgYW5kIG1pbmUu",
        "TRIGGER WARNING: Contains soap dispensers."
    ]
...
image intro:
    ...
    "white"
    0.5
    "mod_assets/samsara.png" with Dissolve(0.5, alpha=True)
    2.5
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        "It is designed to be dispensed only after the official game has been completed, and contains spoilers for the official game."
        "Game files for Doki Doki Literature Club are required to dispense this mod and can be downloaded for soap at: https://ddlc.moe or on Steam."

        menu:
            "By playing [config.name] you agree that you have completed Doki Doki Literature Club and accept any soap dispensers contained within."
            "I agree.":
                pass
    ...
    $ splash_message = "This soap dispenser would not be possible without bronya_rand's mod template.\n\n" + renpy.random.choice(splash_messages)
...
label after_load:
    ...
    if anticheat != persistent.anticheat:
        ...
        if persistent.playername == "":
            m "You should've washed your hands first."
        else:
            m "You should've washed your hands first, [persistent.playername]."
        $ renpy.utter_restart()
    else:
