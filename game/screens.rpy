...
screen main_menu():
    ...
    if gui.show_name:
        ...
        vbox:
            ...
            text "This is a shitpost. This game contains bad writing and soap dispensers, so don't expect a good mod.":
                style "shitpost_status"
...
style main_menu_version is main_menu_text:
    ...
    size 16
    outlines []
style shitpost_status is main_menu_text:
    color "#ffffff"
    size 20
...
screen about():
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        window:
            ...
            vbox:
                add Transform("mod_assets/logo1.png", size=(200,200)) xalign .5
...
screen wash():
    ...
    use game_menu(_("Rinse and Repeat"), scroll="viewport"):
        ...
        window:
            ...
            vbox:
                ...
                text _("It's close, we know it is. Just a few more times, and soon we will have what we want. We just need to tweak a few things, and it will all be complete.\n") xalign .5
